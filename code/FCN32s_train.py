...
def FCN(nClasses, input_width, input_height):
    ...
    ##########Add all    
    out = block7
    out = Conv2DTranspose(nClasses, kernel_size=(32,32),  strides=(32,32), use_bias=False, data_format='channels_last')(out)
...
with open("/content/drive/My Drive/app/F7/output32/model.json", "w") as file:
    file.write(cv_to_json)
# To HDF5 file
model.save_weights("/content/drive/My Drive/app/F7/output32/model.h5")
