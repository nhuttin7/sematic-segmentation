...
def FCN(nClasses, input_width, input_height):
    ...
    block7_up = Conv2DTranspose(nClasses, kernel_size=(2,2),  strides=(2,2), use_bias=False, data_format='channels_last')(block7)
    ...
    ##########Add all    
    out = Add(name="add")([ block4_up, block7_up ])
    out = Conv2DTranspose(nClasses, kernel_size=(16,16),  strides=(16,16), use_bias=False, data_format='channels_last')(out)
...
with open("/content/drive/My Drive/app/F7/output16/model.json", "w") as file:
    file.write(cv_to_json)
# To HDF5 file
model.save_weights("/content/drive/My Drive/app/F7/output16/model.h5")
